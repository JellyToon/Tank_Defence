...
//bool ModelClass::InitializePlane(ID3D11Device* device, const WCHAR* textureFileName, int x, int y)
//{
//	bool result;
//
//	// Initialize the vertex and index buffers.
//	result = InitializeBuffersPlane(device, x, y);
//	if (!result)
//	{
//		return false;
//	}
...
//bool ModelClass::InitializeBuffersPlane(ID3D11Device* device, int x, int y)
//{
//	VertexType* vertices;
//	unsigned long* indices;
//	D3D11_BUFFER_DESC vertexBufferDesc, indexBufferDesc;
...
//
//			vertices[index].position = XMFLOAT3(float(x) * 1, 0.f, float(z) * 1);
//			vertices[index].texture = XMFLOAT2(x / (terrainWidth - 1.f), z / (terrainWidth - 1.f));
